...
REPO = "https://github.com/ThaiTu2602/Day21-Track3-Finetuning-Lab_2A202601504.git"
if not os.path.exists("Day21-Track3-Finetuning-Lab_2A202601504"):
    subprocess.run(["git", "clone", "-q", REPO], check=True)
os.chdir("Day21-Track3-Finetuning-Lab_2A202601504")
